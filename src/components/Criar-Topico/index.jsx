...
const CriarTopico = ({event}) => {
    ...
    return (
        ...
        <>
            {sentTopic? <TopicoEnviado event={()=>setSentTopic(false)}/> : <section className="ct-topicos"> 
           ...
           <div className="ct-topicos__assunto">
                ...
                <div className="box-assunto">
                    <p>Defina um tópico sucinto para notificar os autores...</p>
                </div>
           </div>
           ...
           <div className="ct-topicos__conteudo">
                ...
                <div className="box-conteudo">
                   ...
                   <div className="box-rodape">
                       <img src={Negrito} alt="Ícone Negrito" className="negrito-icon"/>
                       <img src={Italico} alt="Ícone Itálico" className="italico-icon" />
                       <button onClick={()=> setSentTopic(true)}> Enviar </button>
                   </div>
                </div>
           </div>
